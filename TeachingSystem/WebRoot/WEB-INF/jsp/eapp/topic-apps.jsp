		...
		<div class="container-fluid">
			<div class="row-fluid">
				<form action="./toSetApp" method="post">
					...
					<input type="hidden" name="topicName" id="topicName" value="${topicName}"/>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">
									<b>已</b>添加到<b>${topicName}</b>的游戏列表
									<input type="hidden" value="${topicName}" id="topicName"/>
								</h3>
							</div>
									...
									<table class="table" frame="void">
										<tr>
											<td style="text-align: left;">
												<button class="btn btn-default" type="button" onclick="showAddApp(${topicId});">
													...
													<td>
														...
														<c:choose>
															<c:when test="${app.stickState==1}">
																<a href="javascript:cancelTopState(${topicId},${app.appId});"><i class="glyphicon glyphicon-heart" title="置顶"></i></a>
															</c:when>
															<c:otherwise>
