...
<html>
	<head>
		...
		<script src="../resources/js/eapp/topic.js">
</script>
	</head>
	<body>
										...
										<tr>
											<td style="text-align: left;">
												<form class="form-inline">
													 <div class="form-group">
													  ...
													  <button type="button" class="btn btn-default" onclick="searchGame();">
											...
											<td style="text-align: right;">
												<button class="btn btn-default" type="button"
													onclick="addAppToTopic();">
													<i class="glyphicon glyphicon-plus"></i> 添加到<b>${topicName}</b>
												</button>
											</td>
										</tr>
									</table>
